...
// 👇 require con ruta ABSOLUTA (evita MODULE_NOT_FOUND por cwd o case)
const remitosImgCtrl = require(
  path.resolve(__dirname, '..', 'controllers', 'remitosImagenes.controller.js')
);
...
/* --- Imágenes primero (evita colisión con :nrremito) --- */
